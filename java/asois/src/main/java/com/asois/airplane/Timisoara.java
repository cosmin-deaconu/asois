...
public class Timisoara {

	static int k =1;
	public static void main(String[] args) throws InterruptedException, SQLException {
		String nameOfAeroport="tsr";
		String cityName="Timisoara";
    	...
    	driver.navigate().to("https://www.flightradar24.com/data/airports/tsr/arrivals");
    	wait.until(ExpectedConditions.elementToBeClickable(By.xpath(".//*[@id='cnt-data-content']/div/div[2]/div/aside/div[1]/table/thead/tr[2]/td/button")));
    	
    	if(isElementPresent(driver, By.xpath(".//*[@id='cnt-data-content']/div/div[2]/div/aside/div[1]/table/thead/tr[2]/td/button"))){
...
//        	Date date = Date.from(dateBeforeXDays.toInstant(ZoneOffset.UTC));
            ...
            for (k=1; k<=rowSize; k++){
    	        ...
    	        status="Arrivals";
    	        st.execute("INSERT INTO timisoara VALUES (NULL, '"+dateDB+"','"+time+"','"+flight+"','"+airplane+"','"+aircraft+"','"+status+"')");
    	    ...
    	    String value = null;
            String getDate = null;
    	    String select = "SELECT @date:=date,@count := COUNT(*) from timisoara WHERE date like '"+dateDB+"';";
            ...
            String insert="INSERT INTO timisoaranumber VALUES(NULL,'"+getDate+"','"+value+"');";
            st.execute(insert);
        	Thread.sleep(2000);
